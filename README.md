...
You're reading the documentation for the next release of alexa-app, which should be 4.2.2. Please see [CHANGELOG](CHANGELOG.md) and make sure to read [UPGRADING](UPGRADING.md) when upgrading from a previous version. The current stable release is [4.2.1](https://github.com/alexa-js/alexa-app/tree/v4.2.1).
