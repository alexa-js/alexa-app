...
You're reading the documentation for the stable release of alexa-app, 4.2.1. Please see [CHANGELOG](CHANGELOG.md) and make sure to read [UPGRADING](UPGRADING.md) when upgrading from a previous version.
